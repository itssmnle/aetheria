  ...
  return (
    <nav className="sidebar-nav">
      ...
      <div className="sidebar-logo-section">
        ...
        <span className="sidebar-logo-text">AETHERIA</span>
      </div>
      ...
      <div className="sidebar-links">
        ...
        <Link to="/mods" className={`sidebar-link ${location.pathname === '/mods' ? 'active' : ''}`}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
      ...
      <div className="sidebar-socials">
        ...
        <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="social-tile" aria-label="X (Twitter)">
